...
export const planets = [
    ...
    new PlanetObject("Earth",    1.0, 0.00000562, 0.0167086, -0.00004392, -0.00001531, -0.01294668, 0, 0, 102.93768193, 0.32327364, Math.floor(Date.now() / 1000), 0x00ff40, 6378,   "As far as we know Earth is the only hospitable planet for life in our solar system. Diameter at its equator = 12 756 km. Average distance from the sun = 149,6M of km (1 UA). Complete rotation on its axis = 23 hours 56 minutes. Orbit around the Sun = 365 days 1/4. Moons: 1", "textures/Earth.jpg"),
