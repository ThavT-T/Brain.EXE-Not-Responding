...
class AstronomicalObject {
    constructor(name, semiMajorAxis, eccentricity, inclination, longitudeAscendingNode, longitudePerihelion, color, radius, info) {
        this.name = name;
...
export const planets = [
    new AstronomicalObject("Mercury", 0.387098,  0.20563,   7.00497902, 48.33076593, 29.124, 0xffbf00, 2439.7, "Closest planet of the sun. Diameter at its equator = 4 878 km. Average distance from the sun = 58M of km (0,39 UA). Complete rotation on its axis = 58 days 16 hours. Orbit around the Sun = 88 days. Moons: 0"),
    new AstronomicalObject("Venus",    0.723332,   0.006772,   3.39467605,  76.67984255,   54.884,    0x0000ff, 6051.8, "Brightest object in the Earth sky after the Sun and the moon. Diameter at its equator = 12 104 km. Average distance from the sun = 108M of km (0,72 UA). Complete rotation on its axis = 243 days. Orbit around the Sun = 224,7 days. Moons: 0"),
    new AstronomicalObject("Earth",    1.0,        0.0167086,  7.155,       -11.26064,     114.2078,  0x00ff40, 6378, "As far as we know Earth is the only hospitable planet for life in our solar system. Diameter at its equator = 12 756 km. Average distance from the sun = 149,6M of km (1 UA). Complete rotation on its axis = 23 hours 56 minutes. Orbit around the Sun = 365 days 1/4. Moons: 1"),
    new AstronomicalObject("Mars",     1.523679,   0.0934,     1.84969142,  49.55953891,   286.502,   0xff0000,3389.5, "Also known as the Red planet, Mars has a lot of colors at its surface due to oxidization. Diameter at its equator = 6 794 km. Average distance from the sun = 228M of km (1,5 UA). Complete rotation on its axis = 24 hours 37 minutes. Orbit around the Sun = 687 days. Moons: 2"),
    new AstronomicalObject("Jupiter",  5.2044,     0.0489,     1.30439695,  100.47390909,  273.867,   0x8000ff, 69911, "It’s the largest planet in our solar system, Jupiter is a gas giant. Diameter at its equator = 143 000 km. Average distance from the sun = 778M of km (5,2 UA). Complete rotation on its axis = 9 hours 55 minutes. Orbit around the Sun = 11,9 years. Moons: 79"),
    new AstronomicalObject("Saturn",   9.5826,     0.0565,     2.48599187,  113.66242448,  339.392,   0xff00ff, 58232, "Saturn has the most complex and spectacular rings of our solar system. Diameter at its equator = 140 000 km. Average distance from the sun = 1 427M of km (9,5 UA). Complete rotation on its axis = 10 hours 33 minutes. Orbit around the Sun = 29,5 years. Moons: 62"),
    new AstronomicalObject("Uranus",   19.2184,    0.046381,   0.77263783,  74.01692503,   96.99886,  0x00ffff, 25362, "Uranus is a ice giant. Diameter at its equator = 51 100 km. Average distance from the sun = 2 870M of km (19,2 UA). Complete rotation on its axis = 17 hours 14 minutes. Orbit around the Sun = 84 years. Moons: 27"),
    new AstronomicalObject("Neptune",  30.110387,  0.009456,   1.77004347,  131.78422574,  276.336,   0x80ff00, 24397, "The most distant planet of the Sun, it’s also an ice giant, it’s the only planet not visible to the naked eye in the earth sky. Diameter at its equator = 49 500  km. Average distance from the sun = 4 497M of km (30,1 UA). Complete rotation on its axis = 16 hours 7 minutes. Orbit around the Sun = 165 years days. Moons: 14"),
];
