...
export const planets = [
    new PlanetObject("Mercury",  0.387098,   0.00000037,  0.20563,     0.00001906,  7.00497902, -0.00594749, 48.33076593,  -0.12534081,  77.45779628,  0.16047689, Math.floor(Date.now() / 1000), 0xffbf00, 2439.7, "Mercury: Closest planet of the sun \nDiameter at its equator = 4 878 km \nAverage distance from the sun = 58M of km (0,39 UA) \nComplete rotation on its axis = 58 days 16 hours \nOrbit around the Sun = 88 days \nMoons: 0", "textures/Mercury.jpg"),
    new PlanetObject("Venus",    0.723332,   0.00000390,  0.006772,  - 0.00004107,  3.39467605, -0.00078890, 76.67984255,  -0.27769418,  131.60246718, 0.00268329, Math.floor(Date.now() / 1000), 0x0000ff, 6051.8, "Venus: Brightest object in the Earth sky after the Sun and the moon \niameter at its equator = 12 104 km \nAverage distance from the sun = 108M of km (0,72 UA) \nComplete rotation on its axis = 243 days \nOrbit around the Sun = 224,7 days \nMoons: 0", "textures/Venus.png"),
    new PlanetObject("Earth",    1.0,        0.00000562,  0.0167086, - 0.00004392, -0.00001531, -0.01294668, 0,             0,           102.93768193, 0.32327364, Math.floor(Date.now() / 1000), 0x00ff40, 6378,   "Earth: As far as we know Earth is the only hospitable planet for life in our solar system \nDiameter at its equator = 12 756 km \nAverage distance from the sun = 149,6M of km (1 UA) \nComplete rotation on its axis = 23 hours 56 minutes \nOrbit around the Sun = 365 days 1/4 \nMoons: 1", "textures/Earth.jpg"),
    new PlanetObject("Mars",     1.52371034, 0.00001847,  0.09339410,  0.00007882,  1.84969142, -0.00813131, 49.55953891,  -0.29257343, -23.94362959,  0.44441088, Math.floor(Date.now() / 1000), 0xff0000, 3389.5, "Mars: Also known as the Red planet, Mars has a lot of colors at its surface due to oxidization \nDiameter at its equator = 6 794 km \nAverage distance from the sun = 228M of km (1,5 UA) \nComplete rotation on its axis = 24 hours 37 minutes \nOrbit around the Sun = 687 days /nMoons: 2", "textures/Mars.png"),
    new PlanetObject("Jupiter",  5.2044,    -0.00011607,  0.0489,     -0.00013253,  1.30439695, -0.00183714, 100.47390909,  0.20469106,  14.72847983,  0.21252668, Math.floor(Date.now() / 1000), 0x8000ff, 69911,  "Jupiter: It’s the largest planet in our solar system, Jupiter is a gas giant \nDiameter at its equator = 143 000 km \nAverage distance from the sun = 778M of km (5,2 UA) \nComplete rotation on its axis = 9 hours 55 minutes \nOrbit around the Sun = 11,9 years \nMoons: 79", "textures/Jupiter.jpg"),
    new PlanetObject("Saturn",   9.5826,    -0.00125060,  0.0565,     -0.00050991,  2.48599187,  0.00193609, 113.66242448, -0.28867794,  92.59887831, -0.41897216, Math.floor(Date.now() / 1000), 0xff00ff, 58232,  "Saturn: Saturn has the most complex and spectacular rings of our solar system \nDiameter at its equator = 140 000 km \nAverage distance from the sun = 1 427M of km (9,5 UA) \nComplete rotation on its axis = 10 hours 33 minutes \nOrbit around the Sun = 29,5 years \nMoons: 62", "textures/Saturn.jpg"),
    new PlanetObject("Uranus",   19.2184,   -0.00196176,  0.046381,   -0.00004397,  0.77263783, -0.00242939, 74.01692503,   0.04240589,  170.95427630, 0.40805281, Math.floor(Date.now() / 1000), 0x00ffff, 25362,  "Uranus: Uranus is a ice giant \nDiameter at its equator = 51 100 km \nAverage distance from the sun = 2 870M of km (19,2 UA) \nComplete rotation on its axis = 17 hours 14 minutes \nOrbit around the Sun = 84 years \nMoons: 27", "textures/Uranus.jpg"),
    new PlanetObject("Neptune",  30.110387,  0.00026291,  0.009456,    0.00005105,  1.77004347,  0.00035372, 131.78422574, -0.00508664,  44.96476227, -0.32241464, Math.floor(Date.now() / 1000), 0x80ff00, 24397,  "Neptune The most distant planet of the Sun, it’s also an ice giant, it’s the only planet not visible to the naked eye in the earth sky \nDiameter at its equator = 49 500  km \nAverage distance from the sun = 4 497M of km (30,1 UA) \nComplete rotation on its axis = 16 hours 7 minutes \nOrbit around the Sun = 165 years days \nMoons: 14", "textures/Neptune.jpg")
];
